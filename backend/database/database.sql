...
INSERT INTO houses (start_price, city, address, property_type, living_area, rooms, build_year, parking, exterior, description, tags ) VALUES (5120000, 'Linköping', 'Ekbackevägen 22, 582 45 Linköping', 'House', '155 m²', 6, 1994, 'Garage', 'Backyard', 'A spacious family villa located in a quiet residential area. The home offers bright living spaces, a large garden, and excellent outdoor areas for entertaining.', '{"Fireplace", "Smart home"}');
INSERT INTO houses (start_price, city, address, property_type, living_area, rooms, build_year, parking, exterior, description, tags) VALUES (3450000, 'Gothenburg', 'Linnégatan 18C, 413 04 Gothenburg', 'Apartment', '72 m²', 3, 2016, 'Rent parking', 'Balcony', 'Modern apartment in a vibrant city district with open-plan design, balcony, and access to a shared rooftop terrace.', '{"Elevator", "Walk-in closet", "Central location", "Smart home"}');
INSERT INTO houses (start_price, city, address, property_type, living_area, rooms, build_year, parking, exterior, description, tags ) VALUES (6780000, 'Växjo', 'Björkås Gård 7, 355 91 Växjö', 'Farm', '210 m²', 7, 1923, 'Garage', 'Farmland', 'A charming countryside farm with renovated main house, extensive land, and peaceful surroundings close to nature.', '{"Fireplace", "Sea view", "Newly renovated"}');
INSERT INTO houses (start_price, city, address, property_type, living_area, rooms, build_year, parking, exterior, description, tags ) VALUES (3980000, 'Malmö', 'Rosengången 11, 217 63 Malmö', 'House', '118 m²', 5, 2007, 'Private parking', 'Backyard', 'Well-planned townhouse with private outdoor spaces, located in a family-friendly neighborhood with good city access.','{"Family friendly", "Pool", "Central location"}');


INSERT INTO houses (start_price, city, address, property_type, living_area, rooms, build_year, parking, exterior, description, tags ) VALUES (3295000, 'Sundsvall', 'Ängsblomsvägen 27, 856 41 Sundsvall', 'Semi-detached house', '126 m²', 5, 2003, 'Private driveway', 'Backyard', 'A bright and welcoming semi-detached home with a practical layout and plenty of natural light. The property offers a private garden, a spacious deck and comfortable living areas suitable for both families and entertaining.','{"Family friendly", "Fireplace", "Home office", "Energy efficient", "Quiet area"}');
INSERT INTO houses (start_price, city, address, property_type, living_area, rooms, build_year, parking, exterior, description, tags ) VALUES (2175000, 'Norrköping', 'Kvarnrosgatan 9A, 602 18 Norrköping', 'Apartment', '54 m²', 2, 2020, 'Private underground parking space', 'French balcony', 'A modern two-room apartment with a clean Scandinavian design and an efficient floor plan. The recently built property combines comfortable interiors with convenient shared outdoor spaces.','{"Smart home", "Modern kitchen", "Open floor plan", "Move-in ready", "Storage space"}');
INSERT INTO houses (start_price, city, address, property_type, living_area, rooms, build_year, parking, exterior, description, tags ) VALUES (1895000, 'Karlstad', 'Björkheden 16, 656 92 Karlstad', 'Cottage', '89 m²', 4, 1978, 'Detached single garage', 'Large garden', 'A charming countryside cottage with a warm and relaxed atmosphere. The home features a spacious garden, traditional veranda and several outdoor areas perfect for quiet summer days.','{"Fireplace", "Pet friendly", "Renovated", "Nature nearby"}');
