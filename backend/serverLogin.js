...
router.post('/', async (req, res) => {
    ...
    const { rows, rowCount } = await database.query('SELECT * FROM accounts WHERE username = $1 AND password = $2', [user.username, user.password]);
...
//# sourceMappingURL=serverLogin.js.map